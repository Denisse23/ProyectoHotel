...
<html>
    ...
    <head>
        ...
        <script type="text/javascript" src="<%= application.getContextPath()+"/js/reservar.js"%>"></script>
    ...
    <body>
        ...
        <div class="requerimientos">
                        <form id="form-categoria-reservar" method="POST" action="reservar.jsp">
                                ...
                                <form id="form-relizar-busqueda" action="reservar.jsp" method="POST">
                                ...
                                <%    try {
                                      ...
                                      %>
                                       ...
                                       <%contadorrows++;}}catch(Exception e){}%>
